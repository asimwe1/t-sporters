      ...
      <div className="flex flex-row my-16 justify-between">
        ...
        <form className="flex flex-col mx-auto w-2/6  my-auto ">
          ...
          <div className="flex flex-col mb-1">
            <input name="name" type="text" placeholder="name" className="border-b-2 w-2/4 mb-6 text-black outline-none placeholder:text-gray-400 placeholder:text-sm" />
            <input name="email" type="email" placeholder="Email or phone number" className="border-b-2 w-2/4 mb-6 text-black outline-none placeholder:text-gray-400 placeholder:text-sm" />
            <input name="password" type="password" placeholder="Password" className="border-b-2 w-2/4 mb-6 text-black outline-none placeholder:text-gray-400 placeholder:text-sm" />
          </div>
